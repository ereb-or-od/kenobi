...
func parseRequestBody(c *HttpClient, r *Request) (err error) {
...
func addCredentials(c *HttpClient, r *Request) error {
...
func requestLogger(c *HttpClient, r *Request) error {
	if c.Debug {
		rr := r.RawRequest
...
func responseLogger(c *HttpClient, res *Response) error {
	if c.Debug {
...
func handleMultipart(c *HttpClient, r *Request) (err error) {
...
func handleFormData(c *HttpClient, r *Request) {
	formData := url.Values{}
...
func handleContentType(c *HttpClient, r *Request) {
...
func handleRequestBody(c *HttpClient, r *Request) (err error) {
	var bodyBytes []byte
	contentType := r.Header.Get(hdrContentTypeKey)
	kind := kindOf(r.Body)
	r.bodyBuf = nil
...
func saveResponseIntoFile(c *HttpClient, res *Response) error {
	if res.Request.isSaveResponse {
		file := ""
